...
WebUI.setText(findTestObject('Object Repository/Page_Watsons User/input_Name, Email, Updated By_Input_Search'), watsonsUser_Name)
...
for (int row = 0; row < rows_count; row++) {
	...
	if (columnName_value == watsonsUser_Name || columnName_value.contains(watsonsUser_Name)) {
		println("This row has: $watsonsUser_Name")
		isMatch = true
