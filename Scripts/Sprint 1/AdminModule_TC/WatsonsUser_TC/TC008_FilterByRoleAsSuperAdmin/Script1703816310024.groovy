...
WebUI.selectOptionByLabel(findTestObject('Object Repository/Page_Watsons User/selection_SelectRole'), watsonsUser_SuperAdmin, true)
...
for (int row = 0; row < rows_count; row++) {
	...
	if (columnRole_value == watsonsUser_SuperAdmin || columnRole_value.contains(watsonsUser_SuperAdmin)) {
		println("This row has: $watsonsUser_SuperAdmin")
		isMatch = true
