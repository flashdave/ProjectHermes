...
WebUI.setText(findTestObject('Object Repository/Page_Watsons User/input_Name, Email, Updated By_Input_Search'), watsonsUser_UpdatedBy)
...
for (int row = 0; row < rows_count; row++) {
	...
	if (columnUpdatedBy_value == watsonsUser_UpdatedBy || columnUpdatedBy_value.contains(watsonsUser_UpdatedBy)) {
		println("This row has: $watsonsUser_UpdatedBy")
		isMatch = true
