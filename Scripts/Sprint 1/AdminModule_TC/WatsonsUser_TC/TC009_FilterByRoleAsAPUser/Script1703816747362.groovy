...
WebUI.selectOptionByLabel(findTestObject('Object Repository/Page_Watsons User/selection_SelectRole'), watsonsUser_APuser, true)
...
for (int row = 0; row < rows_count; row++) {
	...
	if (columnRole_value == watsonsUser_APuser || columnRole_value.contains(watsonsUser_APuser)) {
		println("This row has: $watsonsUser_APuser")
		isMatch = true
