...
WebUI.setText(findTestObject('Object Repository/Page_Watsons User/input_Name, Email, Updated By_Input_Search'), watsonsUser_Email)
...
for (int row = 0; row < rows_count; row++) {
	...
	if (columnEmail_value == watsonsUser_Email || columnEmail_value.contains(watsonsUser_Email)) {
		println("This row has: $watsonsUser_Email")
		isMatch = true
