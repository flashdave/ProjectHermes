...
WebUI.selectOptionByLabel(findTestObject('Object Repository/Page_Watsons User/selection_SelectRole'), watsonsUser_Admin, true)
...
for (int row = 0; row < rows_count; row++) {
	...
	if (columnRole_value == watsonsUser_Admin || columnRole_value.contains(watsonsUser_Admin)) {
		println("This row has: $watsonsUser_Admin")
		isMatch = true
