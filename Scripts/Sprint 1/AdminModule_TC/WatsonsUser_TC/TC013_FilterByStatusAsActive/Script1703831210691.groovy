...
WebUI.selectOptionByLabel(findTestObject('Object Repository/Page_Watsons User/selection_Status'), 'Active', false)
...
for (int row = 0; row < rows_count; row++) {
	...
	if (columnStatus_value == 'Active') {
		println("This row has status: Active")
		isMatch = true
