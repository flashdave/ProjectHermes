...
WebUI.selectOptionByLabel(findTestObject('Object Repository/Page_Watsons User/selection_Rows per page'), 'Rows per page 50', false)
...
WebUI.verifyEqual(rows_count, 50)
