...
for (int row = 0; row < rows_count; row++) {
	...
	if ((columnName_value == watsons_Username) && (columnEmail_value == watsons_Email) && (columnTicketType_value == result) && (columnRole_value == watsons_Role) && (columnUpdatedBy_value == userAccount) && (columnUpdateDate_value == formattedDateTime) && (columnStatus_value == 'Active')) {
