...
WebUI.setText(findTestObject('Object Repository/Page_Remittance Advice/input_Vendor Code_input-search'), vendor_code)
...
for (int row = 0; row < rows_count; row++) {
	...
	String vendorCode_value = Columns_row.get(1).getText()
	
	
	if (vendorCode_value == vendor_code) {
		println("This row has: $vendor_code")
		isMatch = true
