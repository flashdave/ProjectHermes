...
WebUI.setText(findTestObject('Object Repository/Page_Remittance Advice/input_RA Number'), vendor_RAnumber)
...
for (int row = 0; row < rows_count; row++) {
	...
	String vendorRAnumber_value = Columns_row.get(3).getText()
	
	
	if (vendorRAnumber_value == vendor_RAnumber) {
		println("This row has: $vendor_RAnumber")
		isMatch = true
