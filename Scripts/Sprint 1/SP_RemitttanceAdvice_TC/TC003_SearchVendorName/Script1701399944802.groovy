...
WebUI.setText(findTestObject('Object Repository/Page_Remittance Advice/input_Vendor Name_input-search'), vendor_name)
...
for (int row = 0; row < rows_count; row++) {
	...
	String vendorName_value = Columns_row.get(2).getText()
	
	
	if (vendorName_value == vendor_name) {
		println("This row has: $vendor_name")
		isMatch = true
