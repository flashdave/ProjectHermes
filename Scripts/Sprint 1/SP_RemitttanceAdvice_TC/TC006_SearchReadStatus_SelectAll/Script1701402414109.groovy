...
WebUI.selectOptionByIndex(findTestObject('Object Repository/Page_Remittance Advice/select_Status'), 0)
...
for (int row = 0; row < rows_count; row++) {
	...
	String readStatus_value = Columns_row.get(7).getText()
	
	
	if (readStatus_value == "Read" || readStatus_value == "Unread") {
		println("This row has: $readStatus_value")
		isMatch = true
