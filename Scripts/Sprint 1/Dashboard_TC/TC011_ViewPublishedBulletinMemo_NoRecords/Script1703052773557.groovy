...
WebUI.getText(findTestObject('Page_Homescreen/counter_BulletinMemo'))

WebUI.click(findTestObject('Page_Homescreen/counter_BulletinMemo'))

WebUI.verifyElementText(findTestObject('Page_Homescreen/popupPublished_Bulletin Memo'), 'Bulletin Memo')
