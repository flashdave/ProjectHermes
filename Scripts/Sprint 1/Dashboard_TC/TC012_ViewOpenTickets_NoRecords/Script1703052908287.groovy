...
WebUI.getText(findTestObject('Page_Homescreen/counter_Tickets'))

WebUI.click(findTestObject('Page_Homescreen/counter_Tickets'))

WebUI.verifyElementText(findTestObject('Page_Homescreen/popupOpen_Tickets'), 'Tickets')
