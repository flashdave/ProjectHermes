...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_Login/input_WATSONS COMMAND CENTER_password'), 'P5k+p8A8pUQrhblKSHBMTToIR+E8gbN/')
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Invalid Permissions/invalidDesc_You dont have permissions to view the r_886a38'), 
