...
WebUI.setText(findTestObject('Object Repository/Page_Login/input_WATSONS COMMAND CENTER_username'), GlobalVariable.AP_username)

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Login/input_WATSONS COMMAND CENTER_password'), GlobalVariable.AP_password)
